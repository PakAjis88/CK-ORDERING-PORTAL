...
- The reporting form is **only open from the 20th through the end of each
  month** (whatever the real last day is — 28th/29th/30th/31st). Outside that
  window it's locked, with a "preview/testing" override toggle for admin/QA
  use —
...
5. Whether the 20th-through-end-of-month stock window should have an actual
   admin-configurable override (vs. the prototype's public "preview" checkbox).
...
20th-through-end-of-month stock window.
