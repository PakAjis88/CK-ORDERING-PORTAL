...
const DICT = {
  en: {
    ...
    windowClosed: 'Reporting opens from the 20th to the end of each month.',
    noSubmissionThisMonth: 'No stock report was submitted for {month}.',
    reportLocked: 'This month\'s report has already been submitted and is locked. Ask your operator to reopen it if you need to make changes.',
    alreadySubmitted: 'Already submitted on {date}.',
    ...
    expiryRequired: 'Expiry Date 1 is required for Dry Products & Nuts items with a stock balance entered.',
    expiryInvalid: 'Some expiry dates are invalid. Use dd/mm/yy with a real date, no later than {year}.',
    ...
    unitsOutOfStock: '{qty} units · out of stock (reported {date})', outOfStockRemark: 'Out of stock (reported {date})',
    ...
    recoverEmailTitle: 'Reset your password', recoverEmailHint: 'Enter your login email to continue.',
    recoverContinue: 'Continue', noRecoverySetUp: 'No recovery question is set up for this account — ask your operator for help.',
    recoverAnswerTitle: 'Answer your security question', securityAnswer: 'Your answer',
    newPassword: 'New password', confirmPassword: 'Confirm new password', passwordMismatch: 'Passwords do not match.',
    recoverSubmit: 'Reset password', recoverSuccess: 'Password reset — you can sign in with your new password now.',
    setupRecoveryPrompt: 'Set up account recovery so you can reset your password yourself if you ever forget it.',
    setupRecoveryNow: 'Set up now', notNow: 'Not now',
    securityQuestionPlaceholder: 'Write a question only you would know the answer to',
  ...
  ms: {
    ...
    windowClosed: 'Laporan dibuka dari 20hb hingga akhir bulan.',
    noSubmissionThisMonth: 'Tiada laporan stok dihantar untuk {month}.',
    reportLocked: 'Laporan bulan ini telah dihantar dan dikunci. Sila hubungi operator untuk buka semula jika ada perubahan.',
    alreadySubmitted: 'Telah dihantar pada {date}.',
    ...
    expiryRequired: 'Tarikh Luput 1 wajib diisi untuk item Barang Kering & Kacang yang ada baki stock.',
    expiryInvalid: 'Ada tarikh luput yang tidak sah. Guna format dd/mm/yy dengan tarikh yang betul, tidak melebihi tahun {year}.',
    ...
    unitsOutOfStock: '{qty} unit · habis stock (dilaporkan {date})', outOfStockRemark: 'Habis stock (dilaporkan {date})',
    ...
    forgotPassword: 'Lupa kata laluan?', backToLogin: 'Kembali ke log masuk',
    recoverEmailTitle: 'Set semula kata laluan', recoverEmailHint: 'Masukkan e-mel log masuk anda untuk teruskan.',
    recoverContinue: 'Teruskan', noRecoverySetUp: 'Tiada soalan keselamatan disediakan untuk akaun ini — hubungi operator untuk bantuan.',
    recoverAnswerTitle: 'Jawab soalan keselamatan anda', securityAnswer: 'Jawapan anda',
    newPassword: 'Kata laluan baru', confirmPassword: 'Sahkan kata laluan baru', passwordMismatch: 'Kata laluan tidak sepadan.',
    recoverSubmit: 'Set semula kata laluan', recoverSuccess: 'Kata laluan telah ditetapkan semula — anda boleh log masuk dengan kata laluan baru sekarang.',
    setupRecoveryPrompt: 'Sediakan pemulihan akaun supaya anda boleh set semula kata laluan sendiri jika terlupa.',
    setupRecoveryNow: 'Sediakan sekarang', notNow: 'Bukan sekarang',
    securityQuestionPlaceholder: 'Tulis soalan yang hanya anda tahu jawapannya',
    securityAnswerPlaceholder: 'Jawapan anda',
