...
const DICT = {
  en: {
    ...
    qtyOnHand: 'Qty on hand (units)', nearestExpiry: 'Nearest expiry', qtyOnHand2: 'Qty on hand 2 (units)', nearestExpiry2: 'Nearest expiry 2', unitsPerCartonHint: '{n} {unit}/carton', submitStock: 'Submit stock report',
  ...
  ms: {
    ...
    qtyOnHand: 'Kuantiti ada (unit)', nearestExpiry: 'Luput terdekat', qtyOnHand2: 'Kuantiti ada 2 (unit)', nearestExpiry2: 'Luput terdekat 2', unitsPerCartonHint: '{n} {unit}/karton', submitStock: 'Hantar Laporan Stok',
