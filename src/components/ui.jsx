...
export function Thumb({ src, alt, size = 11 }) {
  const dim = size === 14 ? 'w-14 h-14' : 'w-11 h-11'
  return (
    <div className={`${dim} rounded-md bg-slate-100 border border-slate-200 flex items-center justify-center text-slate-300 shrink-0 overflow-hidden`}>
      {src ? (
